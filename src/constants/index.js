    ...
    items: [
      {
        ...
        video: "/assets/videos/frontend-dev.mp4",
      },
      {
      ...
      },
      {
        ...
        hoverDescription: "Scalable database structures for user accounts, e-commerce, booking systems, CMS. Experience with Row Level Security (RLS), complex relationships, and real-time features. Built production-ready schemas with proper indexing and security.",
        video: "/assets/videos/database-design.mp4",
      },
      {
        title: "Payment & API Integrations",
        description: "(Stripe, Google Drive API, OAuth 2.0, Webhooks)",
        hoverDescription: "Payment processing with Stripe, third-party API integrations (Google Drive, OAuth), webhook handling, and secure authentication flows. Built complete e-commerce order systems with payment verification.",
        video: "/assets/videos/backend-dev.mp4",
      },
    ],
  },
