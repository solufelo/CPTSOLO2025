...
- **React Vulnerability Patch (CVE-2025-55182)**
  - Updated `react` and `react-dom` to version `^19.2.1` to address critical Server Functions protocol vulnerability.
  - Vulnerability affected React 19.0, 19.1, and 19.2.
  - **Action Required:** Run `npm install` to ensure local environments are updated.

### Added - December 08, 2025
- **New Blog Post: Gemini Visual Prompts Study Guide**
  - Created detailed guide "How I Used Gemini Visual Prompts to Ace My OOP Exam"
  - Content includes 5 specific prompts and generated visual examples for OOP concepts
  - Visuals cover: Analogies (House Blueprint, Universal Remote), Mnemonics (A PIE), Cheat Sheets, and Error Patterns
  - **Files Created/Modified:**
    - `src/pages/blog/GeminiStudyGuide.jsx` - New static blog post component
    - `src/data/blogArticles.js` - Registered new post metadata
    - `src/pages/blog/BlogPost.jsx` - Registered component in staticPosts map
    - `src/AppRouter.jsx` - Added explicit route
  - **Assets Added:**
    - Processed and renamed 11 images in `public/images/java-oop/` (kebab-case naming)
